        ...
        function obj = Frame2TTL(portString)
            ...
            if obj.FirmwareVersion < obj.minSupportedFirmware
                error(['Old Frame2TTL firmware detected, v' num2str(obj.FirmwareVersion) '.' char(10) ...
                    ...
                    'For convenience you may use the firmware upload tool for MATLAB in /Frame2TTL/Firmware/Compiled/'])
            end
            if obj.FirmwareVersion < obj.currentFirmware
                warning(['Old Frame2TTL firmware detected, v' num2str(obj.FirmwareVersion) '.' char(10) ... 
                    'Please update to firmware v' num2str(obj.currentFirmware) '.' char(10) ...
                    'For convenience you may use the firmware upload tool for MATLAB in /Frame2TTL/Firmware/Compiled/'])
            end
            if obj.FirmwareVersion > obj.currentFirmware
